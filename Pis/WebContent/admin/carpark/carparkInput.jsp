...
<table class="table" border="1" cellspacing="0" cellpadding="0"  align="center">
   <tr>
    ...
    <a href="/Pis/admin/carpark/carpark.do"><input type="button" value="주차장 목록" class="button"></a>
   </td>
   </tr>
   <tr>
...
<td colspan=5 align="center">
  ...
  <input type="button" value="목록보기" OnClick="window.location='/Pis/admin/carpark/carpark.do'" class="button">
</td></tr></table>   
</form>     
</body>
</html> 