...
<center>
	...
	<b>${qdb.writer}님의 1:1문의사항</b>
       ...
       onclick="document.location.href='/Pis/admin/board/question.do?pageNum=${pageNum}'">
	</div>
<br>
<form>
...
<form method=post action=/Pis/admin/board/questionContentPro.do>
	...
	<table border="1" cellspacing="0" cellpadding="0" class="table">
		...
		<c:forEach var="dbc" items="${comments}">
			<tr>
				...
				<a href="/Pis/admin/board/questionDelComPro.do?content_num=${dbc.content_num}&comment_num=${dbc.comment_num}&pageNum=${pageNum}">
