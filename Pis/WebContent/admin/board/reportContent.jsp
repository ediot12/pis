...
<table border="1" cellspacing="0" cellpadding="0" align="center" class="table"> 
  <tr height="30">
    ...
    <td align="center" width="35%" align="center" class="colorblack">${rdb.writer}</td>
    <td align="center" width="15%" class="color">불편종류</td>
    <td align="center" width="35%" align="center" class="colorblack">${rdb.type}</td>
  </tr>
  <tr height="30">
    <td align="center" class="color">제목</td>
    <td align="center" align="center" class="colorblack" colspan="3">${rdb.subject}</td>
  </tr>
  <tr height="450">
