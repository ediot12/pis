...
<body>
	...
	<table class= "maintable">
		...
		<tr height="15">
			...
			<td class="maincolor"><a href="/Pis/semi/admin/board/noticeContent.do?num=${bdb.num}&pageNum=${currentPage}">${bdb.subject}</a></td>
	...
	<table class="maintable">
		...
		<c:forEach var="fdb" items="${articleList2}">
        	<tr>
	            ...
	            <td class="maincolor"><a href="/Pis/semi/admin/board/FAQ.do">${fdb.subject}</a></td>
           </tr>
       	</c:forEach>
    </td>
    </tr>
