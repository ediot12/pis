...
<table class="parktable" border="1" cellspacing="0" cellpadding="0"  align="center">
   <tr>
    <td align="right" colspan="4">
    <a href="/Pis/semi/admin/carpark/carpark.do"><input type="button" value="주차장 목록" class="parkbutton"></a>
   </td>
   </tr>
   <tr>
    <td class="parktitletd">주차장 코드</td>
    <td>
       <input type="text" size="10" maxlength="10" name="parking_code"></td>
    <td class="parktitletd">주차장 이름</td>
    <td>
       <input type="text" size="20" name="parking_name"></td>
  </tr>
  <tr>
    <td class="parktitletd">주차장 주소</td>
    <td colspan="3">
       <input type="text" size="50" name="addr">
	</td>
  </tr>
  <tr>
    <td class="parktitletd">주차장 종류</td>
    <td>
  ...
  <tr>
    <td class="parktitletd">전화번호</td>
    <td colspan="3">
     <input type="text" size="20" maxlength="11" name="tel">
	</td>
  </tr>
  <tr>
    <td class="parktitletd">주차가능대수</td>
    <td>
     <input type="text" size="8" name="capacity2">
	</td>
    <td class="parktitletd">유/무료 구분</td>
    <td>
  ...
  <tr>
    <td class="parktitletd">평일 운영 시간</td>
    ...
    <td class="parktitletd">주말 운영 시간</td>
  ...
  <tr>
    <td class="parktitletd">주말 유/무료 구분</td>
    <td>
    ...
    <td class="parktitletd">공휴일 유/무료 구분</td>
    <td>
...
<td colspan=5 align="center">
  <input type="submit" value="글쓰기" class="parkbutton"> 
  <input type="reset" value="다시작성" class="parkbutton">
  <input type="button" value="목록보기" OnClick="window.location='/Pis/semi/admin/carpark/carpark.do'" class="parkbutton">
</td></tr></table>   
</form>     
</body>
</html> 