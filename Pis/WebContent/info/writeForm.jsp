		...
		<form method="post" name="writeform"
			...
			<table class="table" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td colspan="3" align="left" ><input type="text" name="zipcode" size="7" readonly="readonly">
				...
				<tr>
					<td align="center" class="color">내용</td>
      				<td colspan="3"><textarea name="content"  cols="148" rows="20"></textarea></td>
					</td>
				</tr>
