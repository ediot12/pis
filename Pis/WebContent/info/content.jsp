	...
	<br>
			...
			<table width="800" height="200"border="1" cellpadding="0" cellspacing="0" 
				...
				<tr>
					...
					<td class="colorblack" colspan="3" align="left">&nbsp;${article.writer}</td>
				</tr>
				
				<!-- 제목 -->
				<tr>
					<td height="40" width="70" class="color"><b>제목</b></td>
					<td class="colorblack" colspan="3" align="left">&nbsp;${article.subject}</td>
				</tr>
				<!-- 우편번호 -->
				<tr>
					<td height="40" width="70" class="color"><b>우편번호</b></td>
					<td class="colorblack" colspan="3" align="left">&nbsp;${article.zipcode}</td>
				</tr>
				<!-- 주소 -->
				<tr>
					<td height="40" width="70" class="color"><b>주소</b></td>
					<td class="colorblack" colspan="3" align="left">&nbsp;${article.address}</td>
				</tr>
