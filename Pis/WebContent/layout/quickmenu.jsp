...
<div id="menu">
	...
	<div name="reservation" align="center" class="menubar1">
		<a href="/Pis/park/parkmap.do"><img src="../image/reservation.png" width="70" height="60"><br>예약하기</a>
	</div>
	<div name="poing" align="center" class="menubar1">
		<a href="/Pis/pointcharge/point.do"><img src="../image/point.png" width="70" height="60"><br>포인트충전</a>
	</div>
