...
public class PisDBBean {
	...
	public void insertArticle(PisDataBean article) throws Exception {
		...
		try {
			...
			// 쿼리문 작성
			sql = "insert into Notice(num,subject,readcount,writer,content)" + "values(Notice_num.NEXTVAL,?,?,?,?)";
	...
	public List getArticles(int start, int end) throws Exception {
		...
		try {
			...
			pstmt = conn.prepareStatement(
					"select num,writer,readcount,subject,content,regdt,rownum r from Notice where rownum >= ? and rownum <= ? order by num desc");
	...
	public List getArticles(int start, int end, int n, String search) throws Exception {
		...
		try {
			...
			String sql = "select num,writer,subject,regdt,content,readcount,r "
					+ "from (select num,writer,subject,regdt,content,readcount,rownum r "
					+ "from (select num,writer,subject,regdt,content,readcount "
